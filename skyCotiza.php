...
<body class="m-2">
    ...
    <form action="" method="post">
        ...
        <div class="row m-2">
            Ancho :<input type="number" name="" id="" class="form-control col-2">
            Alto: <input type="number" name="" id="" class="form-control col-2">
            Profundidad: <input type="number" name="" id="" class="form-control col-2">
        </div>
        <div class="row m-2">
            Peso (kg):<input type="number" name="" id="" class="form-control col-2"><br>
        </div>
...
<?php
if ( isset($_POST['zipfrom'])  &&  isset($_POST['zipto']) ) {
    $body = [
    ...
    echo ('From: ' . $_POST['zipfrom'] . ' To: ' . $_POST['zipto']);
    ...
    for ($i = 0; $i < count($Jdatos); $i++) {
        echo ('<a href="">Paquetería:  ' . $Jdatos[$i]['provider'] . "  Precio:  " . $Jdatos[$i]['amount_local'] . '</a><br>');
    }
    curl_close($ch);
} else {
    echo ('Ingresa código postal origen y destino');
}
?>